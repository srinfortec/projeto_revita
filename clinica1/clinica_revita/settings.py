"""
Django settings for clinica_revita project.
...
SECRET_KEY = 'r!lk$0rsk0t3rnf*b5x!ll4o+sbnn7opm9xyw&==+u)z4@px%k'
...
ROOT_URLCONF = 'clinica_revita.urls'
...
WSGI_APPLICATION = 'clinica_revita.wsgi.application'
